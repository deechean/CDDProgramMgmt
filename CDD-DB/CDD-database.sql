...
-- -----------------------------------------------------
-- Table `cdd`.`dic_teamrole`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cdd`.`dic_teamrole` ;

CREATE TABLE IF NOT EXISTS `cdd`.`dic_teamrole` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `desc` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `cdd`.`t_teammember` (
  ...
  CONSTRAINT `FK_TEAMMEMBER_ROLE`
    FOREIGN KEY (`roleid`)
    REFERENCES `cdd`.`dic_teamrole` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `cdd`.`t_derivablepermission`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cdd`.`t_derivablepermission` ;

CREATE TABLE IF NOT EXISTS `cdd`.`t_derivablepermission` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `derivableid` INT NULL,
  `roleid` INT NULL,
  `permission` BINARY(8) NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `FK_DERIVABLEPERMISSION_DERIVABLE_idx` (`derivableid` ASC) VISIBLE,
  INDEX `FK_DERIVABLEPERMISSION_ROLE_idx` (`roleid` ASC) VISIBLE,
  CONSTRAINT `FK_DERIVABLEPERMISSION_DERIVABLE`
    FOREIGN KEY (`derivableid`)
    REFERENCES `cdd`.`t_deliverable` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_DERIVABLEPERMISSION_ROLE`
    FOREIGN KEY (`roleid`)
    REFERENCES `cdd`.`t_teammember` (`roleid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cdd`.`t_deliverableitems`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cdd`.`t_deliverableitems` ;

CREATE TABLE IF NOT EXISTS `cdd`.`t_deliverableitems` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `derivableid` INT NOT NULL,
  `name` VARCHAR(255) NOT NULL,
  `parentitemid` INT NOT NULL,
  `attribute` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `FK_DERIVABLEITEM_DERIVABLE_idx` (`derivableid` ASC) VISIBLE,
  CONSTRAINT `FK_DERIVABLEITEM_DERIVABLE`
    FOREIGN KEY (`derivableid`)
    REFERENCES `cdd`.`t_deliverable` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `cdd`.`t_deliverableitems_copy1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cdd`.`t_deliverableitems_copy1` ;

CREATE TABLE IF NOT EXISTS `cdd`.`t_deliverableitems_copy1` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `derivableid` INT NULL,
  `name` VARCHAR(255) NULL,
  `parentitemid` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `cdd`.`t_deliverableitemsvalues`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cdd`.`t_deliverableitemsvalues` ;

CREATE TABLE IF NOT EXISTS `cdd`.`t_deliverableitemsvalues` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `derivableitemattr` INT NULL,
  `typeid` INT NULL,
  `value` VARCHAR(255) NULL,
  `derivableitemid` INT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `FK_DERIVABLEITEM_DERIVABLE0_idx` (`derivableitemid` ASC) VISIBLE,
  INDEX `FK_DERIVITEMATTR_TYPE_idx` (`typeid` ASC) VISIBLE,
  CONSTRAINT `FK_DERIVITEMATTR_DELIVITEM`
    FOREIGN KEY (`derivableitemid`)
    REFERENCES `cdd`.`t_deliverableitems` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_DERIVITEMATTR_TYPE`
    FOREIGN KEY (`typeid`)
    REFERENCES `cdd`.`dic_fieldtype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
